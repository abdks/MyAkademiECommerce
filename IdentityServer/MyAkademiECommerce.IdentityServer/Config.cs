...
namespace MyAkademiECommerce.IdentityServer
{
    ...
    new IdentityResources.Email()
        ...
        public static IEnumerable<ApiScope> ApiScopes => new ApiScope[]
        {
         ...
         new ApiScope("DiscountReadPermission","Discount Read Permission Authority For Discount Read Operations"),
         new ApiScope("DiscountCreatePermission","Discount Create Permission Authority For Discount Create Operations"),
     ...
     new Client
    {
        ...
        ClientSecrets={new Secret("ecommercesecret".Sha256())},
        AllowedScopes={ "CatalogReadPermission", "CatalogFullPermission", "DiscountReadPermission", "DiscountCreatePermission", "DiscountFullPermission", "OrderEditPermission","BasketFullPermission", "OrderFullPermission",IdentityServerConstants.LocalApi.ScopeName },
